...
function BorderWidthPicker({ label, value, onChange }) {
    const [borderWidths, setBorderWidths] = useState(value || { top: 0, right: 0, bottom: 0, left: 0 });
    ...
    const handleSideChange = useCallback(
        (side, newValue) => {
            ...
            const newWidths = { ...borderWidths, [side]: numericValue };
            setBorderWidths(newWidths);
            onChange && onChange(newWidths);
        },
        [borderWidths, onChange]
    );
    ...
    const uniform = useMemo(() => borderWidths.top === borderWidths.right && borderWidths.top === borderWidths.bottom && borderWidths.top === borderWidths.left, [borderWidths]);

    const displayValue = useMemo(() => (uniform ? borderWidths.top.toString() : "mixed"), [uniform, borderWidths]);
                            ...
                            <div style={popoverPaneStyle}>
                                <BlockStack gap="300">
                                    ...
                                    <div style={inputContainerStyle}>
                                        <TextField
                                            label=""
                                            value={borderWidths.top.toString()}
                                    ...
                                    <InlineStack wrap={false} gap={300}>
                                        <TextField
                                            label=""
                                            value={borderWidths.left.toString()}
                                        ...
                                        <TextField
                                            label=""
                                            value={borderWidths.right.toString()}
                                    ...
                                    <div style={inputContainerStyle}>
                                        <TextField
                                            label=""
                                            value={borderWidths.bottom.toString()}
